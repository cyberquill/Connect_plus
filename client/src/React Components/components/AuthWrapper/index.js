            ...
            <div className="auth__back">
                <div className="auth">
                    ...
                    <div className="auth__display">
                        <img src={authArt} alt="" className="auth__display__art" />
                        <Logo dimension='130px' others='auth__display__logo' />
                        ...
                        <div className="auth__display__footer">
                            <i class="fas fa-info-circle ml-5 mr-2"></i>
                            ...
                            <div className="auth__display__footer--icons">
                                ...
                                <i class="fab fa-instagram"></i> |<i class="fas fa-share-alt"></i> |
